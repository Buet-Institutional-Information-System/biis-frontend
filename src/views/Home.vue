<template>
    <div >
        <v-img :src=$store.getters.getUserImage class="pa-4" style="margin-left: 35%; margin-top:2%;height:15%;width:15%;  border-width: 20px;border-color:lightgrey;   border-style: double"></v-img>
        <v-card
